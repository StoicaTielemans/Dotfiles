...
const AboutMeDetails: FC = () => {
  ...
  return (
      <div className="bg-white min-h-screen mt-20 pt-18 px-4 sm:px-6 md:px-10 ">
      ...
      <div className="flex flex-col">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 items-start">
          ...
          Using a nested flex container with space-y-6 so that each text field stacked vertically
          effectively occupies 1 row height within the layout grid.
        */}
          <div className="w-full flex flex-col lg:col-span-3 justify-center">
            <div className="space-y-6">
              {/* Row 1 Text Field - Study choice reason */}
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 lg:ml-8 sm:p-6 shadow-lg border border-white/10 ">
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 lg:ml-8 sm:p-6 shadow-lg border border-white/10 ">
                ...
                <ul className="list-disc list-inside text-sm sm:text-base">
                  {(t("softSkills", { returnObjects: true }) as string[]).map(
                      (hobby) => (
                          <li key={hobby} className="mb-2 text-sm">
                            {hobby}
                          </li>
                      ),
                  )}
      ...
      <div className="lg:col-span-4 pt-4">
        <div className="bg-white/5 backdrop-blur-sm rounded-lg p-4 sm:p-6 shadow-lg border border-white/10">
          <h2 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-primary">
            {t("aboutMeTitle2")}
          </h2>
