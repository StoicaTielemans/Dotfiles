...
const Portfolio: FC = () => {
  ...
  const projects: ProjectType[] =
    (i18n.getResourceBundle(i18n.language, "projects") as ProjectType[]) || [];
        ...
        <div className="grid grid-cols-1 gap-10 mt-10">
          {projects.map((project, index) => (
            <div
              ...
              className={`bg-white rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2 flex flex-col cursor-pointer ${
