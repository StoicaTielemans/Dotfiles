      ...
      <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="bg-white rounded-lg shadow-md p-8 md:p-12">
            <div className="space-y-6 text-gray-700 leading-relaxed">
              ...
              <p className="text-lg">Tijdens de stage heb ik veel geleerd over het ontwikkelen van software in een professionele omgeving. Ik heb geleerd hoe belangrijk het is om goed te communiceren met collega's en klanten, en hoe je moet omgaan met feedback en verbeteringen. Daarnaast heb ik geleerd hoe je efficiënt kunt werken met verschillende technologieën en tools, en hoe je problemen kunt oplossen in een teamsetting.</p>
            </div>
        </div>
        ...
        <div>
          ...
          <p className="text-lg p-10">
            Hieronder vindt u de documenten die ik heb gerealiseerd tijdens mijn stageperiode, waaronder het projectplan, het realisatiedocument en het reflectiedocument, met als aanvullend document mijn stageverslag.
          </p>
