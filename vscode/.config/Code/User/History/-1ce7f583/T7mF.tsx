...
<div className="space-y-2 text-sm sm:text-base text-gray-600">
  <p><span className="font-semibold text-gray-800">Analytisch & Strategisch:</span> Ik hou ervan om voor complexe problemen effectief oplossingen te bedenken.</p>
  <p><span className="font-semibold text-gray-800">Leergierig & Zelfstandig:</span> De IT-wereld staat nooit stil. Ik pak graag nieuwe technologieën op.</p>
  <p><span className="font-semibold text-gray-800">Samenwerken:</span> Ik functioneer uitstekend in teamverband. Zowel tijdens softwareprojecten als in het dagelijkse contact zorg ik voor een heldere communicatie.</p>
</div>
          </div>
